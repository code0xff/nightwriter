  ...
  "relative w-full rounded-md border px-3 py-2 text-xs [&>svg+div]:translate-y-[-2px] [&>svg]:absolute [&>svg]:left-3 [&>svg]:top-3 [&>svg]:text-foreground [&>svg~*]:pl-6",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-warning/40 bg-warning/10 [&>svg]:text-warning [color:hsl(38_92%_30%)]",
        info: "border-info/40 bg-info/10 [&>svg]:text-info [color:hsl(var(--info))]",
        success:
          "border-success/40 bg-success/10 [&>svg]:text-success [color:hsl(var(--success))]",
      },
    },
    defaultVariants: {
      variant: "default",
